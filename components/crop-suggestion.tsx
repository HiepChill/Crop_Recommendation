...
export function CropSuggestion() {
  ...
  const handlePredict = async (selectedSoilRegion?: string, isBasicTab: boolean = false, overrideParams?: Params) => {
    ...
    try {
      ...
      const translatedResult: PredictionResult = {
        ...
        alternatives: data.alternatives.map((alt: { name: string; confidence: number }) => ({
            ...
            <TabsContent value="advanced">
              <div className="space-y-6">
                ...
                <div className="pt-4 flex justify-center">
                  <Button 
                    onClick={() => handlePredict(undefined, false)}
                    disabled={isLoading}
            ...
            <CardContent className="p-4">
              {isLoading ? (
                ...
                <div className="flex flex-col items-center justify-center h-full text-center py-12">
                  ...
                  <p className="text-gray-300">Chọn loại đất và khu vực hoặc điều chỉnh thông số để xem kết quả.</p>
                </div>
              ) : (
                <div className="space-y-6">
